...
namespace Awesome_Plugin\Dependencies\ExtCPTs;
...
class PostTypeAdmin {
	...
	public function init(): void {
		 ...
		 * @since 5.0.0
		 *
		 * @param \Awesome_Plugin\Dependencies\ExtCPTs\PostTypeAdmin $instance The extended post type admin instance.
		 */
	...
	public function filters(): void {
		...
		foreach ( $this->args['admin_filters'] as $filter_key => $filter ) {
			...
			if ( has_action( $hook ) ) {
				 ...
				 * @since 4.3.0
				 *
				 * @param \Awesome_Plugin\Dependencies\ExtCPTs\PostTypeAdmin $controller The post type admin controller instance.
